exports.id=9289,exports.ids=[9289],exports.modules={62290:()=>{},51674:()=>{},4873:(e,t,o)=>{"use strict";function r(e,t,o,r,i){let a=process.env.SITE_NAME||"Jesus Worship and Restoration Church",n=process.env.NEXT_PUBLIC_URL||"http://localhost:3000";return{subject:`Event Registration Confirmed: ${t}`,html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
\xa9 ${new Date().getFullYear()} ${a}. All rights reserved.
    `.trim()}}function i(e,t,o,r,i,a){let n=process.env.SITE_NAME||"Jesus Worship and Restoration Church";return process.env.NEXT_PUBLIC_URL,{subject:`Your Event Ticket: ${t}`,html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
\xa9 ${new Date().getFullYear()} ${n}. All rights reserved.
    `.trim()}}function a(e,t){let o=process.env.SITE_NAME||"Jesus Worship and Restoration Church",r=process.env.NEXT_PUBLIC_URL||"http://localhost:3000";return{subject:`Volunteer Application Received: ${t}`,html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
\xa9 ${new Date().getFullYear()} ${o}. All rights reserved.
    `.trim()}}function n(e,t){let o=process.env.SITE_NAME||"Jesus Worship and Restoration Church",r=process.env.NEXT_PUBLIC_URL||"http://localhost:3000",i={suggestion:"Suggestion",complaint:"Complaint",praise:"Praise",question:"Question"}[t]||"Feedback";return{subject:`Thank You for Your ${i}`,html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
This is an automated confirmation email. Please do not reply to this message.
\xa9 ${new Date().getFullYear()} ${o}. All rights reserved.
    `.trim()}}function s(e,t,o,r){let i=process.env.SITE_NAME||"Jesus Worship and Restoration Church";process.env.NEXT_PUBLIC_URL;let a=r?r[0].toUpperCase()+r.slice(1):"Feedback";return{subject:`Response to your ${a} from ${i}`,html:`${t.replace(/\n/g,"<br/>")}`,text:`${t}`.trim()}}function l(e,t){let o=process.env.SITE_NAME||"Jesus Worship and Restoration Church",r=process.env.NEXT_PUBLIC_URL||"http://localhost:3000";return{subject:`Verify Your Email Address - ${o}`,html:`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
\xa9 ${new Date().getFullYear()} ${o}. All rights reserved.
    `.trim()}}o.d(t,{Fj:()=>i,SJ:()=>l,YP:()=>r,e1:()=>n,getSuggestionResponseEmail:()=>s,oY:()=>a})}};