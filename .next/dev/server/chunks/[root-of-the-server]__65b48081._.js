...
function getVolunteerAcceptanceEmail(name, role, message) {
    const siteName = process.env.SITE_NAME || 'Jesus Worship and Restoration Church';
    const siteUrl = process.env.NEXT_PUBLIC_URL || 'http://localhost:3000';
    return {
...
"[project]/jwrc/app/api/suggestions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/jwrc/node_modules/.pnpm/next@16.1.0_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$2c$__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f40$prisma$2b$client$40$4$2e$16$2e$0_prisma$40$4$2e$16$2e$0$2f$node_modules$2f40$prisma$2f$client$29$__ = __turbopack_context__.i("[externals]/@prisma/client [external] (@prisma/client, cjs, [project]/jwrc/node_modules/.pnpm/@prisma+client@4.16.0_prisma@4.16.0/node_modules/@prisma/client)");
...
;
;
const prisma = new __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$2c$__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f40$prisma$2b$client$40$4$2e$16$2e$0_prisma$40$4$2e$16$2e$0$2f$node_modules$2f40$prisma$2f$client$29$__["PrismaClient"]();
...
async function POST(req) {
    try {
        ...
        if (Object.keys(errors).length) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            errors
        }, {
            status: 400
        });
        ...
        try {
            if (process.env.SMTP_HOST && process.env.SMTP_USER) {
                try {
                    ...
                    const emailContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSuggestionConfirmationEmail"])(name ? String(name) : '', type ? String(type) : 'suggestion');
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            suggestion: {
                id,
                name,
                email,
...
async function GET(req) {
    try {
        ...
        await ensureTable();
        if (email) {
            const rows = await prisma.$queryRawUnsafe(`SELECT id, name, email, type, message, admin_response as "adminResponse", responder_name as "responderName", created_at as "createdAt", responded_at as "respondedAt" FROM suggestions WHERE LOWER(email) = LOWER($1) ORDER BY created_at DESC`, String(email));
            return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                suggestions: rows
            });
        }
        ...
        if (!token) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unauthorized'
        }, {
            status: 401
        });
        ...
        const rows = await prisma.$queryRawUnsafe(`SELECT id, name, email, type, message, admin_response as "adminResponse", responder_name as "responderName", created_at as "createdAt", responded_at as "respondedAt" FROM suggestions ORDER BY created_at DESC`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            suggestions: rows
        });
    } catch (e) {
...
async function PATCH(req) {
    try {
        ...
        const adminEmailFallback = process.env.ADMIN_EMAIL || '';
        if (payload.role !== 'admin' && String(payload.email || '').toLowerCase() !== adminEmailFallback.toLowerCase()) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden'
        }, {
            status: 403
        });
        ...
        if (!id || !response) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const rows = await prisma.$queryRawUnsafe(`SELECT id, name, email, type FROM suggestions WHERE id = $1 LIMIT 1`, String(id));
        ...
        if (suggestion && suggestion.email) {
            try {
                if (process.env.SMTP_HOST && process.env.SMTP_USER) {
                    ...
                    const { getSuggestionResponseEmail } = await __turbopack_context__.A("[project]/jwrc/lib/email-templates.ts [app-route] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65b48081._.js.map