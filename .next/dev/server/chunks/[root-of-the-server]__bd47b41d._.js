...
async function POST(req) {
    try {
        ...
        await ensureTable();
        await prisma.$executeRawUnsafe(`INSERT INTO donations (amount, currency, kes_amount, method, donor_name, donor_email, note, created_at) VALUES ($1,$2,$3,$4,$5,$6,$7,NOW())`, amount, currency || 'USD', kesAmount || null, method, donor?.name || null, donor?.email || null, body?.note || null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd47b41d._.js.map