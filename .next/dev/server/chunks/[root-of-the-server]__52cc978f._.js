...
"[project]/app/api/events/signups/send-reminder/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!event) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (signupIds && Array.isArray(signupIds) && signupIds.length > 0) {
            ...
            signups = await prisma.$queryRawUnsafe(`SELECT id, name, email, phone FROM event_signups WHERE event_id = $1 AND id IN (${placeholders})`, eventId, ...signupIds);
        } else {
            // Send to all signups for this event
            signups = await prisma.$queryRawUnsafe(`SELECT id, name, email, phone FROM event_signups WHERE event_id = $1`, eventId);
        }
        if (signups.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52cc978f._.js.map