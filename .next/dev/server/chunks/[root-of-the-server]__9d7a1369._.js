...
async function GET(req) {
    try {
        ...
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.count({
            where
        });
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.findMany({
            where,
            orderBy: {
                startsAt: 'asc'
            },
...
async function POST(req) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.create({
            data: {
                title: String(title),
...
async function DELETE(req) {
    try {
        ...
        try {
            const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.delete({
                where: {
                    id
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d7a1369._.js.map