...
"[project]/jwrc/app/api/user/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAuthenticatedUser(req) {
    ...
    try {
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$jsonwebtoken$40$9$2e$0$2e$2$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, secret);
...
async function GET(req) {
    try {
        ...
        if (!auth) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unauthorized"
        }, {
            status: 401
        });
...
async function PATCH(req) {
    try {
        ...
        if (updates.email && updates.email !== auth.db.email) {
            try {
                await prisma.$executeRawUnsafe(`UPDATE volunteer_applications SET email = $1 WHERE LOWER(email) = LOWER($2)`, String(updates.email), String(auth.db.email));
            } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe88ce6d._.js.map