...
"[project]/jwrc/lib/qrcode.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$qrcode$40$1$2e$5$2e$4$2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/jwrc/node_modules/.pnpm/qrcode@1.5.4/node_modules/qrcode/lib/index.js [app-route] (ecmascript)");
;
async function generateTicketQRCode(data) {
    ...
    const qrCodeDataURL = await __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$qrcode$40$1$2e$5$2e$4$2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].toDataURL(ticketData, {
...
function parseTicketQRCode(qrData) {
    try {
...
"[project]/jwrc/app/api/events/signups/send-reminder/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$lib$2f$qrcode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/jwrc/lib/qrcode.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        if (!event) return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (signupIds && Array.isArray(signupIds) && signupIds.length > 0) {
            ...
            signups = await prisma.$queryRawUnsafe(`SELECT id, event_id, ref, name, email, phone FROM event_signups WHERE event_id = $1 AND id IN (${placeholders})`, eventId, ...signupIds);
        } else {
            // Send to all signups for this event
            signups = await prisma.$queryRawUnsafe(`SELECT id, event_id, ref, name, email, phone FROM event_signups WHERE event_id = $1`, eventId);
        }
        if (signups.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        for (const signup of signups){
            try {
                ...
                const qrCodeDataURL = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$lib$2f$qrcode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateTicketQRCode"])({
                ...
                const emailContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$jwrc$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEventTicketEmail"])(signup.name, event.title, formatDate(new Date(event.startsAt)), event.location || undefined, signup.ref || 'N/A', 'cid:qrcode@ticket' // Use CID instead of data URL
                );
                ...
                // Mark ticket as sent
                await prisma.$executeRawUnsafe(`UPDATE event_signups SET ticket_sent = true WHERE id = $1`, signup.id);
                sent++;
            } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__192b5976._.js.map