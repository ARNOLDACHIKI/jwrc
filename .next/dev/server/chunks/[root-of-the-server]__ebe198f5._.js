...
async function GET() {
    try {
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].announcement.findMany({
            orderBy: {
                postedAt: 'desc'
            }
        });
...
async function POST(req) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].announcement.create({
            data: {
                title,
                content,
...
async function DELETE(req) {
    try {
        ...
        try {
            const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].announcement.delete({
                where: {
                    id
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebe198f5._.js.map