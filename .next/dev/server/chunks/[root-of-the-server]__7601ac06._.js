...
"[project]/app/api/auth/password-reset/request/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function ensureTable() {
  ...
  `);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeExecute"])(`CREATE INDEX IF NOT EXISTS password_reset_tokens_token_idx ON password_reset_tokens(token)`);
}
...
async function POST(req) {
    try {
        ...
        const { email } = body || {};
        if (!email) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        ;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeExecute"])(`INSERT INTO password_reset_tokens (id, user_id, token, expires_at, used, created_at) VALUES ($1,$2,$3,$4,false,NOW())`, id, user.id, token, expiresAt);
        ...
        const isDev = (("TURBOPACK compile-time value", "development") || 'development') === 'development';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7601ac06._.js.map